...
% mOut = drawPatchInImg(mIn,band,x1,x2,y1,y2,c1Scale,c1Space,rfSizes)
%
% given relevant information about an S2 patch, outline the area from which the
% patch was taken in the original image.
%
...
%
% mOut: double array, the new image, with the patch outlined in black
